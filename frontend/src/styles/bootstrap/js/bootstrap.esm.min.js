...
class BaseComponent extends Config {
	...
	static getInstance(e) {
		return Data.get(getElement(e), BaseComponent.DATA_KEY);
	}
	static getOrCreateInstance(e, t = {}) {
		return (
			BaseComponent.getInstance(e) ||
	...
	static eventName(e) {
		return `${e}${BaseComponent.EVENT_KEY}`;
	}
}
const getSelector = (e) => {
...
class Dropdown extends BaseComponent {
	...
	static dataApiKeydownHandler(e) {
		...
		if (t && !n) return;
		e.preventDefault();
		const s = Dropdown.matches(SELECTOR_DATA_TOGGLE$3)
				? Dropdown
