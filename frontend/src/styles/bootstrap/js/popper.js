...
!((e, t) => {
	...
	var D = "top",
		...
		H = "viewport",
		T = "popper",
		R = k.reduce((e, t) => e.concat([t + "-" + W, t + "-" + B]), []),
		S = []
			.concat(k, [M])
			.reduce((e, t) => e.concat([t, t + "-" + W, t + "-" + B]), []),
		V = [
			"beforeRead",
			"read",
			"afterRead",
	...
	function Q() {
		for (var e = arguments.length, t = new Array(e), n = 0; n < e; n++)
			t[n] = arguments[n];
		return !t.some((e) => !(e && "function" == typeof e.getBoundingClientRect));
	}
	function Z(e) {
		void 0 === e && (e = {});
		var t = e,
							...
							if (Q(t, n)) {
								(f.rects = {
									...
									f.orderedModifiers.forEach(
										(e) =>
											(f.modifiersData[e.name] = Object.assign({}, e.data)),
									);
	...
	function ue(e, t) {
		...
		var n = t,
			...
			c = void 0 === f ? S : f,
			p = U(r),
			u = p ? (s ? R : R.filter((e) => U(e) === p)) : k,
			l = u.filter((e) => c.indexOf(e) >= 0);
		0 === l.length && (l = u);
		var d = l.reduce(
			(t, n) => (
				(t[n] = J(e, {
